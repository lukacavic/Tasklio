...
return [
    ...
    'profile' => [
        'account' => 'Account',
        'profile' => 'Profile',
        'my_profile' => 'Korisnički profil',
        'subheading' => 'Ovdje upravljajte svojim korisničkim profilom. ',
        'personal_info' => [
        ...
        'password' => [
            'heading' => 'Lozinka',
            'subheading' => 'Lozinka treba imati min. 8 znakova.',
            'submit' => [
                'label' => 'Spremi',
            ],
            'notify' => 'Lozinka je uspješno ažurirana',
        ],
        '2fa' => [
